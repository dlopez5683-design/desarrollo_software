...
export class TicketService {
  ...
  obtenerTicketPorId(id: string): Observable<TicketResponse> {
    return this.http.get<TicketResponse>(`${this.apiUrl}/${id}`);
  }

  crearTicket(ticket: Ticket): Observable<TicketResponse> {
  ...
  eliminarTicket(id: string): Observable<TicketResponse> {
